...
#+fixed rank
model_brms.3.16_random <- brm(log.cort ~ 1 + (1+z.time+quad)*z.age_at_sample +(1+z.time+quad)*z.lcms.code+
...
model_brms.3.16_m61_random.v9.a<-res
save(model_brms.3.16_m61_random.v9.a,file="model_brms.3.16_m61.random.v9.a.RData")
